...
#define MODULE_NAME "disableversioncheck"
#define MODULE_TAG disableversioncheck
...
int hook_init(void) {
	int i;
	SYMSEARCH_BIND_FUNCTION_TO(disableversioncheck, kallsyms_lookup_name, pkallsyms_lookup_name);
	SYMSEARCH_BIND_FUNCTION_TO(disableversioncheck, kallsyms_lookup, pkallsyms_lookup);
