...
static struct single_row_lut samsung_3000_fcc_temp = {
	.x		= {-20, -10, 0, 5, 10, 15, 20, 25, 30, 40, 60},
	.y		= {3080, 3077, 3077, 3076, 3072, 3073, 3074, 3073, 3070, 3069, 3061},
	.cols	= 11
};

static struct single_row_lut samsung_3000_fcc_sf = {
	.x		= {0},
	.y		= {100},
	.cols	= 1
};

static struct pc_temp_ocv_lut samsung_3000_pc_temp_ocv = {
	.rows		= 29,
	.cols		= 11,
...
static struct sf_lut samsung_3000_rbatt_sf = {
	.rows		= 28, 
	.cols		= 11,
...
struct bms_battery_data samsung_3000_data = {
	.fcc			= 3210,
	.fcc_temp_lut		= &samsung_3000_fcc_temp,
	.fcc_sf_lut			= &samsung_3000_fcc_sf,
	.pc_temp_ocv_lut	= &samsung_3000_pc_temp_ocv,
	.rbatt_sf_lut		= &samsung_3000_rbatt_sf,
