...
static struct single_row_lut sony_3000_fcc_temp = {
	.x		= {-20, -10, 0, 5, 10, 15, 20, 25, 30, 40, 60},
	.y		= {3116, 3110, 3106, 3103, 3101, 3099, 3097, 3096, 3095, 3091, 3080},
	.cols	= 11
};

static struct single_row_lut sony_3000_fcc_sf = {
	.x		= {0},
	.y		= {100},
	.cols	= 1
};

static struct pc_temp_ocv_lut sony_3000_pc_temp_ocv = {
	.rows		= 29,
	.cols		= 11,
...
static struct sf_lut sony_3000_rbatt_sf = { 
	.rows		= 28, 
	.cols		= 11,
...
struct bms_battery_data sony_3000_data = {
	.fcc			= 3210,
	.fcc_temp_lut		= &sony_3000_fcc_temp,
	.fcc_sf_lut			= &sony_3000_fcc_sf,
	.pc_temp_ocv_lut	= &sony_3000_pc_temp_ocv,
	.rbatt_sf_lut		= &sony_3000_rbatt_sf,
