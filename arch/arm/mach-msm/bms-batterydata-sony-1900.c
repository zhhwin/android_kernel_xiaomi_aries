...
static struct single_row_lut sony_1900_fcc_temp = {
	.x		= {-20, 0, 25, 40, 60},
	.y		= {1927, 1935, 1943, 1942, 1938},
	.cols	= 5
};

static struct single_row_lut sony_1900_fcc_sf = {
	.x		= {0},
	.y		= {100},
	.cols	= 1
};

static struct pc_temp_ocv_lut sony_1900_pc_temp_ocv = {
	.rows		= 29,
	.cols		= 5,
	.temp		= {-20, 0, 25, 40, 60},
...
static struct sf_lut sony_1900_rbatt_sf = { 
	.rows		= 28, 
	.cols		= 5,
...
static struct sf_lut sony_1900_pc_sf = {
	.rows		= 1,
	.cols		= 1,
...
struct bms_battery_data sony_1900_data = {
	.fcc			= 1900,
	.fcc_temp_lut		= &sony_1900_fcc_temp,
	.fcc_sf_lut		= &sony_1900_fcc_sf,
	.pc_temp_ocv_lut	= &sony_1900_pc_temp_ocv,
	.pc_sf_lut		= &sony_1900_pc_sf,
	.rbatt_sf_lut		= &sony_1900_rbatt_sf,
